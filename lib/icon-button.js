      ...
      return (
        <TouchableHighlight style={[styles.touchable, blockStyle]} {...touchableProps}>
          <View
            ...
            {...props}
          >
            {(() => {if (this.props.labelPostion === "left" || this.props.labelPostion === "top"){return children})()}
            <Icon {...iconProps} />
            {(() => {if (this.props.labelPostion == "right" || this.props.labelPostion === "bottom"){ return children})()}
          </View>
        </TouchableHighlight>
      );
    }
